...
interface ProductAdditionSectionProps extends HTMLAttributes<HTMLDivElement> {
  ...
  handleDeleteProductAttribute: (index: number) => void;
  handleSelectAttributeType: (attribute: Attribute) => void;
  handleAddProductAttribute: (value: string) => void;
}
...
const ProductAdditionSection: FC<ProductAdditionSectionProps> = ({
  ...
  const handleAddProductAttribute = (value: string) => {
    props.handleAddProductAttribute(value);
    ...
    <div className="grid grid-cols-2 gap-8 mb-8">
      ...
      <div className="grid gap-4 grid-cols-3">
        ...
        <div className="space-y-2">
          ...
          <Select onValueChange={(value) => props.handleSelectCategory(value)}>
            <SelectTrigger
              id="category"
        ...
        <div className="space-y-2">
          ...
          <Select onValueChange={(value) => props.handleSelectProvider(value)}>
            <SelectTrigger
              id="provider"
                      ...
                      {attributeService
                        ...
                        .map((attribute, index) => (
                          <CommandItem
                            ...
                            onSelect={() =>
                              props.handleSelectAttributeType(attribute)
                            }
            ...
            {props.productAttributesAddition.map((productAttribute, index) => (
              ...
              >
                ...
                <X
                  ...
                  onClick={() => props.handleDeleteProductAttribute(index)}
                />
              </Badge>
            ))}
          </div>
