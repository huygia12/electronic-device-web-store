...
const ProductCollection: React.FC<HTMLAttributes<HTMLDivElement>> = ({
  ...
  return (
    ...
    >
      ...
      <CarouselPrevious className="top-[13rem] -left-[0.5rem] h-[8rem] w-5 bg-primary rounded-r-sm hover_border-red-500" />
      <CarouselNext className="top-[13rem] -right-[0.5rem] h-[8rem] w-5 bg-primary rounded-s-sm hover_border-red-500" />
    </Carousel>
  );
};
